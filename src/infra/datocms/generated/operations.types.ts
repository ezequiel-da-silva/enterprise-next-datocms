...
export type ContentListingSectionBlockFragmentFragment = { id: string, contentSource: string | null, fetchMode: string | null, allCategoriesLabel: string | null, categoryDisplay: string | null, showSortTabs: boolean, hasLimit: boolean, limit: number | null, displayType: string | null, initialCount: number | null, loadMoreStep: number | null, loadMoreLabel: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, selectedCategories: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, manualPosts: Array<{ id: string, _firstPublishedAt: string, _updatedAt: string, postTitle: string | null, postSlug: string | null, excerpt: string | null, postAuthor: { authorName: string | null } | null, postCategory: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, coverImage: { __typename: 'CardImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null }>, sourceCollection: { shopifyHandle: string | null } | null, selectedProducts: Array<{ title: string | null, shopifyHandle: string | null }>, carouselOptions: Array<{ __typename: 'CarouselSettingRecord', id: string, autoplay: boolean, autoplayInterval: number | null, showArrows: boolean, showDots: boolean, loop: boolean }> };
...
export type PageBySlugQuery = { page: { id: string, title: string | null, slug: string | null, heroPage: { __typename: 'HeroSectionRecord', id: string, layoutHero: string | null, titleHero: string | null, showButton: boolean, showImageHero: boolean, showImageOverlay: boolean, subtitleHero: { value: unknown, blocks: Array<string>, links: Array<string>, inlineBlocks: Array<string> } | null, buttonHero: Array<{ __typename: 'LinkRecord', id: string, ctaLabel: string | null, typeContent: string | null, externalLink: string | null, openInNewTab: boolean, ctaLinkAria: string | null, internalLinkPage: { __typename: 'PageRecord', slug: string | null } | null, internalLinkPost: { __typename: 'PostRecord', postSlug: string | null } | null, internalLinkCategory: { __typename: 'CategoryRecord', categorySlug: string | null } | null, internalLinkAuthor: { __typename: 'AuthorRecord', authorSlug: string | null } | null, internalLinkProduct: { __typename: 'ProductPageRecord', shopifyHandle: string | null, title: string | null } | null, internalLinkCollection: { __typename: 'CollectionPageRecord', shopifyHandle: string | null, title: string | null } | null }>, imageHero: { __typename: 'HeroImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null, imageOverlay: { __typename: 'HeroImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null } | null, contentPage: Array<
      ...
      | { __typename: 'ContentListingSectionRecord', id: string, contentSource: string | null, fetchMode: string | null, allCategoriesLabel: string | null, categoryDisplay: string | null, showSortTabs: boolean, hasLimit: boolean, limit: number | null, displayType: string | null, initialCount: number | null, loadMoreStep: number | null, loadMoreLabel: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, selectedCategories: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, manualPosts: Array<{ id: string, _firstPublishedAt: string, _updatedAt: string, postTitle: string | null, postSlug: string | null, excerpt: string | null, postAuthor: { authorName: string | null } | null, postCategory: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, coverImage: { __typename: 'CardImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null }>, sourceCollection: { shopifyHandle: string | null } | null, selectedProducts: Array<{ title: string | null, shopifyHandle: string | null }>, carouselOptions: Array<{ __typename: 'CarouselSettingRecord', id: string, autoplay: boolean, autoplayInterval: number | null, showArrows: boolean, showDots: boolean, loop: boolean }> }
