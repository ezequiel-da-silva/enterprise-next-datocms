...
export type ContactFormSectionBlockFragmentFragment = { id: string, hasTextHeader: boolean, successMessage: string | null, privacyNote: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, intro: { value: unknown, blocks: Array<string>, inlineBlocks: Array<string>, links: Array<{ __typename: 'PageRecord', id: string, title: string | null, slug: string | null }> } | null };

export type ContentListingSectionBlockFragmentFragment = { id: string, hasLimit: boolean, limit: number | null, displayType: string | null, initialCount: number | null, loadMoreStep: number | null, loadMoreLabel: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, listingConfig:
    | { __typename: 'BlogListingConfigRecord', id: string, fetchMode: string | null, filterDisplay: string | null, allCategoriesLabel: string | null, showSortTabs: boolean, selectedCategories: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, manualPosts: Array<{ id: string, _firstPublishedAt: string, _updatedAt: string, postTitle: string | null, postSlug: string | null, excerpt: string | null, postAuthor: { authorName: string | null } | null, postCategory: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, coverImage: { __typename: 'CardImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null }> }
    | { __typename: 'ShopifyListingConfigRecord', id: string, fetchMode: string | null, collectionFilter: string | null, sourceCollection: { shopifyHandle: string | null } | null, selectedProducts: Array<{ title: string | null, shopifyHandle: string | null }> }
   | null, carouselOptions: Array<{ __typename: 'CarouselSettingRecord', id: string, autoplay: boolean, autoplayInterval: number | null, showArrows: boolean, showDots: boolean, loop: boolean }> };

export type CtaBannerBlockFieldsFragment = { id: string, hasEyebrow: boolean, eyebrow: string | null, advancedOptions: boolean, variant: string | null, bgTheme: string | null, hasImage: boolean, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, buttons: Array<{ __typename: 'LinkRecord', id: string, ctaLabel: string | null, typeContent: string | null, externalLink: string | null, openInNewTab: boolean, ctaLinkAria: string | null, internalLinkPage: { __typename: 'PageRecord', slug: string | null } | null, internalLinkPost: { __typename: 'PostRecord', postSlug: string | null } | null, internalLinkCategory: { __typename: 'CategoryRecord', categorySlug: string | null } | null, internalLinkAuthor: { __typename: 'AuthorRecord', authorSlug: string | null } | null, internalLinkProduct: { __typename: 'ProductPageRecord', shopifyHandle: string | null, title: string | null } | null, internalLinkCollection: { __typename: 'CollectionPageRecord', shopifyHandle: string | null, title: string | null } | null }>, imageBanner: Array<{ __typename: 'BannerImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null }> };

export type FeatureGridBlockFragmentFragment = { id: string, advancedOptions: boolean, variant: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, carouselOptions: Array<{ __typename: 'CarouselSettingRecord', id: string, autoplay: boolean, autoplayInterval: number | null, showArrows: boolean, showDots: boolean, loop: boolean }>, itemsFeatureGrid: Array<{ __typename: 'CardRecord', id: string, cardSource: string | null, titleCard: string | null, hasIcon: boolean, iconCard: unknown, hasDescription: boolean, descriptionCard: string | null, hasImage: boolean, hasLink: boolean, sourceProduct: { shopifyHandle: string | null, title: string | null } | null, sourceCollection: { shopifyHandle: string | null, title: string | null } | null, imageCard: { __typename: 'CardImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null, linkCard: { __typename: 'LinkRecord', id: string, ctaLabel: string | null, typeContent: string | null, externalLink: string | null, openInNewTab: boolean, ctaLinkAria: string | null, internalLinkPage: { __typename: 'PageRecord', slug: string | null } | null, internalLinkPost: { __typename: 'PostRecord', postSlug: string | null } | null, internalLinkCategory: { __typename: 'CategoryRecord', categorySlug: string | null } | null, internalLinkAuthor: { __typename: 'AuthorRecord', authorSlug: string | null } | null, internalLinkProduct: { __typename: 'ProductPageRecord', shopifyHandle: string | null, title: string | null } | null, internalLinkCollection: { __typename: 'CollectionPageRecord', shopifyHandle: string | null, title: string | null } | null } | null }> };
...
type TextSectionMediaBlocks_BlogListingConfigRecord_Fragment = { __typename: 'BlogListingConfigRecord', id: string };
...
type TextSectionMediaBlocks_ContactFormSectionRecord_Fragment = { __typename: 'ContactFormSectionRecord', id: string };

type TextSectionMediaBlocks_ContentListingSectionRecord_Fragment = { __typename: 'ContentListingSectionRecord', id: string };
...
type TextSectionMediaBlocks_ShopifyListingConfigRecord_Fragment = { __typename: 'ShopifyListingConfigRecord', id: string };
...
export type TextSectionMediaBlocksFragment =
  ...
  | TextSectionMediaBlocks_BlogListingConfigRecord_Fragment
  ...
  | TextSectionMediaBlocks_ContentListingSectionRecord_Fragment
  ...
  | TextSectionMediaBlocks_ShopifyListingConfigRecord_Fragment
...
export type ListProductPagesQueryVariables = Exact<{
  locale: Types.SiteLocale;
}>;


export type ListProductPagesQuery = { allProductPages: Array<{ title: string | null, shopifyHandle: string | null }> };
...
export type PageBySlugQuery = { page: { id: string, title: string | null, slug: string | null, heroPage: { __typename: 'HeroSectionRecord', id: string, layoutHero: string | null, titleHero: string | null, showButton: boolean, showImageHero: boolean, showImageOverlay: boolean, subtitleHero: { value: unknown, blocks: Array<string>, links: Array<string>, inlineBlocks: Array<string> } | null, buttonHero: Array<{ __typename: 'LinkRecord', id: string, ctaLabel: string | null, typeContent: string | null, externalLink: string | null, openInNewTab: boolean, ctaLinkAria: string | null, internalLinkPage: { __typename: 'PageRecord', slug: string | null } | null, internalLinkPost: { __typename: 'PostRecord', postSlug: string | null } | null, internalLinkCategory: { __typename: 'CategoryRecord', categorySlug: string | null } | null, internalLinkAuthor: { __typename: 'AuthorRecord', authorSlug: string | null } | null, internalLinkProduct: { __typename: 'ProductPageRecord', shopifyHandle: string | null, title: string | null } | null, internalLinkCollection: { __typename: 'CollectionPageRecord', shopifyHandle: string | null, title: string | null } | null }>, imageHero: { __typename: 'HeroImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null, imageOverlay: { __typename: 'HeroImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null } | null, contentPage: Array<
      | { __typename: 'ContactFormSectionRecord', id: string, hasTextHeader: boolean, successMessage: string | null, privacyNote: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, intro: { value: unknown, blocks: Array<string>, inlineBlocks: Array<string>, links: Array<{ __typename: 'PageRecord', id: string, title: string | null, slug: string | null }> } | null }
      | { __typename: 'ContentListingSectionRecord', id: string, hasLimit: boolean, limit: number | null, displayType: string | null, initialCount: number | null, loadMoreStep: number | null, loadMoreLabel: string | null, textHeaderSection: Array<{ __typename: 'TextHeaderRecord', id: string, title: string | null, hasDescription: boolean, description: string | null, hasSectionId: boolean, sectionId: string | null }>, listingConfig:
          | { __typename: 'BlogListingConfigRecord', id: string, fetchMode: string | null, filterDisplay: string | null, allCategoriesLabel: string | null, showSortTabs: boolean, selectedCategories: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, manualPosts: Array<{ id: string, _firstPublishedAt: string, _updatedAt: string, postTitle: string | null, postSlug: string | null, excerpt: string | null, postAuthor: { authorName: string | null } | null, postCategory: Array<{ id: string, categoryName: string | null, categorySlug: string | null, categoryColor: { hex: string } | null }>, coverImage: { __typename: 'CardImageBlockRecord', id: string, assetMobile: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null, assetDesktop: { url: string, alt: string | null, width: number | null, height: number | null, blurUpThumb: string | null } | null } | null }> }
          | { __typename: 'ShopifyListingConfigRecord', id: string, fetchMode: string | null, collectionFilter: string | null, sourceCollection: { shopifyHandle: string | null } | null, selectedProducts: Array<{ title: string | null, shopifyHandle: string | null }> }
         | null, carouselOptions: Array<{ __typename: 'CarouselSettingRecord', id: string, autoplay: boolean, autoplayInterval: number | null, showArrows: boolean, showDots: boolean, loop: boolean }> }
